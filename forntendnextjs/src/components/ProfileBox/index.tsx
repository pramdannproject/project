...
const ProfileBox: React.FC = () => {
  ...
  const fetchUserAccount = async () => {
    ...
    try {
      const response = await fetch(`https://${HTTPSAPIURL}/api/users/account`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${token}`, // Menambahkan token ke header
        },
        // Jika API membutuhkan body, tambahkan di sini. Jika tidak, hapus bagian body.
        // body: JSON.stringify({ /* data jika diperlukan */ })
      });
      ...
      setError(err.message || "Failed to fetch user account");
    } finally {
      setLoading(false);
    }
  };
  ...
  if (loading) {
    return (
      <div className="overflow-hidden rounded-[10px] bg-white shadow-1 dark:bg-gray-dark dark:shadow-card p-4">
        <p>Loading...</p>
      </div>
    );
  }
  ...
  return (
    <div className="overflow-hidden rounded-[10px] bg-white shadow-1 dark:bg-gray-dark dark:shadow-card">
      <div className="relative z-20 h-35 md:h-65">
        <Image
          src="/images/cover/cover-01.png" // Anda bisa mengganti ini dengan cover yang dinamis jika tersedia
          alt="profile cover"
        ...
        <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-[176px] sm:p-3">
          ...
          >
            ...
            <input
              ...
              // Anda bisa menambahkan handler untuk mengunggah foto profil di sini
            />
          </label>
        </div>
        <div className="mt-4">
          ...
          <div className="mx-auto mb-5.5 mt-5 grid max-w-[370px] grid-cols-3 rounded-[5px] border border-stroke py-[9px] shadow-1 dark:border-dark-3 dark:bg-dark-2 dark:shadow-card">
            ...
            <div className="flex flex-col items-center justify-center gap-1 px-4 xsm:flex-row">
              ...
              <span className="text-body-sm">Following</span>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-[720px]">
            ...
            <p className="mt-4">
              {/* Anda bisa mengganti ini dengan data dinamis jika tersedia */}
